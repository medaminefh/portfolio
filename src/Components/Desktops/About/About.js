    ...
    <section className=" lg:pt-10 lg:bg-transparent min-h-screen min-w-screen pt-20 bg-blue-100">
      <div>
        <div className=" lg:items-center lg:flex lg:justify-around lg:h-screen">
          <div>
            <h2 className="lg:text-center lg:text-6xl md:text-5xl text-blue-600 text-4xl pl-8">
              Who Am I ?
            </h2>
          ...
          <div className="flex flex-col items-center lg:w-1/4 xl:p-8">
            <img
              draggable="false"
              className="lg:w-full lg:h-full lg:m-0 lg:rounded md:mb-12 mb-8 mt-4 object-cover object-center w-56 h-64 rounded-full border-2 border-orange-900 "
              src={med}
              alt="About me"
            />
          </div>
        ...
        <div
          ...
          className="lg:m-auto lg:pr-20 lg:pb-20 lg:w-4/5 bg-orange-300 pt-8 pr-6 pl-6 mt-3 pb-8"
        >
          <p className=" text-indigo-900 text-2xl md:text-3xl">
          ...
          <h4 className="md:text-4xl text-3xl">I Know :</h4>
          <div>
            {languages.map((l) => (
              <p className="md:text-3xl text-indigo-900 text-2xl pt-3" key={l}>
                {l}{" "}
              </p>
            ))}
          </div>
